...
function Complete-Certificate {
    ...
    #   The name of the computer to execute against. The computer is expected to hold the private key for the certificate request in the REQUEST store.
    ...
    #
    #   The path is relative to the computer the command is executing against.
    #
    #   If the target (ComputerName) is the local system relative paths are permissible. For remote systems a full path must be supplied.
